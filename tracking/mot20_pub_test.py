...
def main(tracktor):
    ...
    for model_dir, output_dir in zip(models, output_dirs):
        ...
        for idx, [samples, meta] in enumerate(data_loader):
            ...
            os.makedirs("/scratch2/scorpio/yixu/transcenterTracking_efficient/sparse_decoder_tracking/check_plot/see_pub_det/", exist_ok=True)
            img_pil.save(f"/scratch2/scorpio/yixu/transcenterTracking_efficient/sparse_decoder_tracking/check_plot/see_pub_det/{im_name[:-4]}.png")
